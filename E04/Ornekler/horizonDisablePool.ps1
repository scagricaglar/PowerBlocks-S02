<# Bu script parametre olarak verilen Desktop Pool ismini Horizon Connection Server üzerinde bulur ve 'Disable' eder.
...
$horizonServer = Connect-HVServer -server localhost -Credential (Import-Clixml C:\horizonScripts\credentials.xml)
...
{
    Write-Host ('Desktop Pool halihazırda "Disabled" durumda. Herhangi bir değişiklik yapılmayacak')
}
